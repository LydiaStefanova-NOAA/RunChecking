...
endwhile
endwhile
'set string 1 l 12'; 'draw string 3 4.6  solid: RMSE, dashed: spread'; 'draw title PRECIP lon='lonW',lon='lonE',lat='latS',lat='latN' '
*'printim GT30.PCP.'year-4'.png'
