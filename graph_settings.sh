...
#
   ...
   domain=Global20       # Valid choices see line 47 (case "$domain" list) in map_compare_obs.sh
   ...
   declare -a season=("DJF" "MAM")                  # Valid choices are "DJF" "MAM" "JJA" "SON" "AllAvailable"
